Feature: Drag and Drop Components in Progression Tree
  ...
  Scenario: User drags a component to a new position
    ...
    And component "app1" is at position (100, 200)
    When the user drags component "app1" to position (300, 400)
    Then component "app1" should be at position (300, 400)
  ...
  Scenario: Component position is restored on page reload
    Given the progression tree is loaded with components
    And component "app1" has a stored position of (300, 400)
    When the user reloads the page
    Then component "app1" should be at position (300, 400)

  Scenario: Multiple components can have custom positions
    Given the progression tree is loaded with components
    When the user drags component "app1" to position (100, 100)
    And the user drags component "app2" to position (200, 200)
    And the user saves the layout
    Then component "app1" should be at position (100, 100)
    And component "app2" should be at position (200, 200)
  ...
  Scenario: Invalid positions are rejected
    Given the progression tree is loaded with components
    When the user attempts to save position (NaN, 400) for component "app1"
  ...
  Scenario: Positions persist across server restarts
    Given the progression tree is loaded with components
    And component "app1" has been dragged to position (300, 400)
  ...
  Scenario: API endpoint saves component position
    ...
    When the API endpoint "POST /api/component-positions" is called with position (300, 400) for "app1"
  ...
  Scenario: API endpoint deletes component position
    Given component "app1" has a stored position of (300, 400)
