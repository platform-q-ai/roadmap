#!/usr/bin/env tsx
// CLI adapter: Rebuild database, seed features, and export to web/data.json.
// Usage: npx tsx src/adapters/cli/component-publish.ts
// This runs the full publish pipeline: seed features + export JSON.
...
try {
  ...
  console.log(`Published to ${OUT_PATH}`);
  console.log(
